...
// Assuming researcherService and HelpRequestPayload are defined and imported correctly
import { researcherService, HelpRequestPayload } from '@/services/researcherService'; 

interface HelpFormProps {
  manuscriptId?: string;
  // Must be a single element (like a Button) because DialogTrigger uses asChild
...
      userId: user?._id, // Use _id from your User interface
      userName: user?.name,
